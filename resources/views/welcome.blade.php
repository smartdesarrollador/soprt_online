...
<html>
  <head>
    ...
    />
    <title>Soporte Online Perú</title>
  </head>
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                <h1 class="text-white font-semibold text-5xl">
                  ¡Bienvenidos a Soporte Online Perú!
                </h1>
                <p class="mt-4 text-lg text-gray-300">
                  Nuestro servicio de tecnología ofrece una amplia gama de soluciones para su negocio. Podemos ayudarlo a mejorar la eficiencia y el rendimiento de su computadora o dispositivo móvil mediante la instalación de sistemas operativos, software de ofimática, programas de diseño y otros.
                </p>
              </div>
            </div>
          </div>
